  ...
  "installing-claude-code": {
    ...
    "sections": [
      ...
      },
      {
        "id": "sec-1",
        "title": "终端",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">在 macOS、Linux 或 WSL 上，使用curl命令一次性安装。如果您更喜欢Homebrew，也可以使用brew install，但请注意，此方法不支持自动更新。</p>\n<p class=\"text-base leading-relaxed text-secondary\">在Windows上，有几个选项。在 PowerShell 中，使用 Invoke-RestMethod 命令。在CMD中，使用curl命令。还有一个 winget 命令可用，但与 Homebrew 一样，它不会自动更新。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/1d77aec524053a8a70e5fd7cc1513d9a179be737f93093001ca96f1f1aaa9fa2.jpg\" alt=\"Terminal showing Claude Code successfully installed via curl\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">安装后，您应该能够运行 claude 命令。如果没有，请重新启动终端。导航到您的项目目录并运行：</p>\n<p class=\"text-base leading-relaxed text-secondary\">您将完成一些初始设置步骤，例如选择颜色主题并使用您的 Claude 帐户（Pro、Max 或 Enterprise）或使用 API 密钥登录。如果您的组织有 Claude Enterprise 帐户，请务必选择该选项。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/6000796786763c8a1862b6cbfbcb1d7b99a61503fd9faf6c39f6e2b98d644119.jpg\" alt=\"Claude Code login method selection: subscription, API, or third-party platform\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">无论您在哪个目录中运行 claude，它都可以访问该目录及其所有子文件夹。</p>"
      },
      {
        "id": "sec-2",
        "title": "视觉工作室代码",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">“扩展”面板并搜索“Claude Code”。找到标有蓝色验证检查的 Anthropic 扩展。点击安装。</p>\n<p class=\"text-base leading-relaxed text-secondary\">安装后，您可能需要重新启动 VS Code。运行后，使用 Ctrl/Cmd + Shift + P 打开命令选项板，然后搜索“Claude Code Open in New Tab”。如果 Claude 徽标在侧边栏中可见，您也可以单击它。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/1a09d51136d3df5f2a31fa884d575b477a6bc379401ec229abedbc9336828c25.jpg\" alt=\"Claude Code extension page in VS Code marketplace\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">VS Code 扩展提供了与终端非常相似的体验。您还可以选择退出 UI 并直接在设置中使用终端体验。</p>"
      },
      {
        "id": "sec-3",
        "title": "捷脑公司",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">从 JetBrains Marketplace 安装 Claude Code 插件。安装后，重新启动 IDE。当您重新打开它时，您将看到 Claude 即可。单击它就会打开一个，其中包含与编辑器一起使用的终端体验。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/a7656728ab6cf289ed0d6a523c2f0b230053e7e69908e77675603f69da0eed2d.jpg\" alt=\"Claude Code plugin in the JetBrains Marketplace\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-4",
        "title": "桌面",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">安装并登录允许Claude桌面后，您将在顶部看到一个标有“代码”的切换开关。外观和感觉与聊天方面类似，但它您在特定的文件夹中工作、更改权限，甚至在云环境中工作。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/dbd3386c65f280868d1a71154b96ee0b1b80d1b44ad5019b7c40be353fc714a1.jpg\" alt=\"Claude Desktop Code view showing recent project folders\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-5",
        "title": "Web",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">在网络上，可以通过访问 claude.ai/code 或单击聊天应用程序侧栏中的“Code”标签来访问 Claude Code。这与桌面应用程序的工作方式类似，但您仅限于 GitHub 存储库。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/3c3609161934207b9e3aeeb18e056f878b86d589601ebd7e39bc23d094b081f1.jpg\" alt=\"Claude Code on the web at claude.ai/code with repository selection\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-6",
        "title": "我应该使用哪一个？",
  ...
  "context-management": {
    ...
    "sections": [
      ...
      },
      {
        "id": "sec-1",
        "title": "什么是上下文窗口？",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">将上下文窗口视为 Claude 在其内存中可以容纳的空间量。每当您输入提示时，Claude 都会读取文件、运行工具调用或接收工具调用结果，所有这些都会添加到上下文窗口中。由于空间有限，因此优化空间的使用方式变得很重要。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/0b452da83b5903a000236abfd55cc34f13f28dbfeb7e3acc9f6da07cdd78241e.jpg\" alt=\"Diagram showing the context window as a grid of tokens — some taken, most available\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-2",
        "title": "当上下文填满时会发生什么",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">当接近限制时，上下文窗口会自动压缩。压缩总结了重要的细节并删除了不必要的工具调用结果以释放空间。请注意，此过程可能会丢失详细信息。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/9511065cfe218d3894f551b9096b6eead92b74f5714126e6ccdd26e2d4a5f4a0.jpg\" alt=\"Claude Code showing 'Compacting conversation...' as it summarizes the context\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/a1539801b08e330701dc44e3361a079860d4586b1eff878237dff5ec28f39e64.jpg\" alt=\"Claude Code displaying a compact summary of the previous conversation including key technical concepts and files\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-3",
        "title": "命令",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">您可以使用 /compact 命令手动运行压缩。这会压缩到目前为止的所有内容。当您想要释放上下文空间同时保留以前所做的工作的记忆时，它会很方便。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/d348719608e1d100f9adaca481d43be6759a9d3e896b67de6054e8cf6591dfe5.jpg\" alt=\"The /compact command in Claude Code's autocomplete menu\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">如果您想完全从头开始，不记得上一个会话，请运行 /clear。这会删除所有内容。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/93098b21ae0152b1fbf763fd9e30ea76e4ada64966526203458bb0a83006851a.jpg\" alt=\"Running /clear in Claude Code to start a fresh session\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">要检查上下文的状态，请运行 /context 命令。您将获得上下文大小、占用最多空间的类别以及显示细分的可视化图形的高级概述。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/d0b6a1d0ad4a21aa61a48751f2d382a77edc3fde154f8f5aebd2509ebc325420.jpg\" alt=\"Output of the /context command showing context usage breakdown with a visual bar chart\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-4",
        "title": "何时使用哪个",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">一般经验法则：</p>\n<ul class=\"flex list-disc flex-col gap-xs pl-lg\">\n<li class=\"text-base leading-relaxed text-secondary\">\n当您正在处理特定功能并遇到上下文限制但需要继续时，请使用 /compact。保持上下文与您当前的功能相关非常重要。\n</li>\n<li class=\"text-base leading-relaxed text-secondary\">\n当您想要启动新功能时，请使用 /clear。你不希望之前的谈话给新事物带来偏见。对于您希望 Claude 在会话中记住的内容，请将它们放入 CLAUDE.md 文件中，这样它就不必从头开始重新发现内容。\n\n</li>\n</ul>\n<p class=\"text-base leading-relaxed text-secondary\">当您正在处理特定功能并遇到上下文限制但需要继续时，请使用 /compact。保持上下文与当前功能相关非常重要。</p>\n<p class=\"text-base leading-relaxed text-secondary\">当您想要启动新功能时，请使用 /clear。你不希望之前的谈话给新事物带来偏见。对于您希望 Claude 在会话中记住的内容，请将它们放入您的 CLAUDE.md 文件中，这样它就不必从头开始重新发现内容。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/c31ad4239bea62c006ae5d41ab0c60d0c0d2e89676ddeee440e139e1690c1f67.jpg\" alt=\"A CLAUDE.md file with commands, important notes, and architecture sections\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-5",
        "title": "节省上下文空间的技巧",
  ...
  "the-claude-md-file": {
    ...
    "sections": [
      ...
      },
      {
        "id": "sec-2",
        "title": "一个例子",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">典型的 CLAUDE.md 文件如下所示：</p>\n<p class=\"text-base leading-relaxed text-secondary\">这很简单。现在，如果您要求 Claude Code 创建一个 React，组件已经知道使用 Tailwind 进行样式设置并遵循您的代码规定。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/3bc0b82a5595e143f7c169346d9cca4e578013befa12eeb71963851299cb097b.jpg\" alt=\"A CLAUDE.md file open in VS Code showing project info, commands, and code style rules\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-3",
  ...
  "mcp": {
    ...
    "sections": [
      ...
      },
      {
        "id": "sec-1",
        "title": "你能用它做什么？",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">首先，理解代理人工智能中“工具”的概念很。工具使像 Claude Code 这样的代理能够执行帮助他们更有效地完成任务的操作。这与典型的人工智能不同，在典型的人工智能中，您必须收到重要的文本回复。</p>\n<p class=\"text-base leading-relaxed text-secondary\">例如，如果您的团队使用 Linear 进行管理，您可以添加 Linear 连接模型上下文协议服务器项目来引入特定问题的详细信息。如果您需要依赖项的最新文档，像 Context7 这样的文档提供连接模型上下文协议服务器，可以将其提供给 Claude Code。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/8b45d337d7061da8f40d66261dede8996ae317467c47f5224bc14a95d7549f54.jpg\" alt=\"Claude Code querying a Linear MCP 协议 server to retrieve issue details for ticket MEN-12\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/d6d21d5d4f27b7b129d16d21e8578d2d754778562751293844160576ab26f545.jpg\" alt=\"Claude Code using the Context7 MCP 协议 server to look up the latest shadcn/ui documentation\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-2",
        "title": "添加连接模型上下文协议协议服务器",
        "contentHtml": "<p class=\"text-base leading-relaxed text-secondary\">您可以使用 claude mcp add 命令添加 MCP 协议服务器。主要有两种类型：</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/2e38357f8b365758bc4d9d96a290c1acd8eafc93f673a38d40738b499bd9453b.jpg\" alt=\"Running claude mcp add to add an HTTP Linear MCP 协议 server from the terminal\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<ul class=\"flex list-disc flex-col gap-xs pl-lg\">\n<li class=\"text-base leading-relaxed text-secondary\">HTTP 服务器用于远程服务。这些由服务提供商托管并通过网络连接。</li>\n<li class=\"text-base leading-relaxed text-secondary\">工作室服务器适用于在您的计算机上运行的本地进程。</li>\n</ul>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/a19228083bd37109bd90468a8d18342a091bc905273c3b5aa4184804b4b1e68c.jpg\" alt=\"Running claude mcp add to add a local stdio MCP 协议 server with a Python script\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>\n<p class=\"text-base leading-relaxed text-secondary\">您可以在 Claude Code 会话中使用 /mcp 管理服务器，以查看连接的内容、检查状态并禁用不需要的服务器。</p>\n<p class=\"text-base leading-relaxed text-secondary\"><img src=\"/claude-academy-zh/assets/media/ad513f212c47b68feec4010cd6d1c2b348d5a1ed94ea1da993e0454d3bf08159.jpg\" alt=\"The /mcp command showing connected MCP 协议 servers and their status\" loading=\"lazy\" class=\"my-md h-auto max-w-full rounded-lg \"></p>"
      },
      {
        "id": "sec-3",
        "title": "确定服务器范围",
